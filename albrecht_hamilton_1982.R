# Simulation based on Albrecht & Hamilton (1982, fig. 4)

library(tidyverse)
library(doParallel)
library(foreach)

Contrast <- c(2, 4, 8, 16, 24, 32, 40, 48, 56, 64, 72, 80, 88, 96)
Rmax = 115
C50 = 19.3
n = 2.9
...
ggsave("albrecht_hamilton_1982_fig_4.png", g, width = 4, height = 5.6, dpi = 300)