...
points_df <- nr %>%
  dplyr::filter(Contrast %in% c(10, 20, 30, 40))
...
plot <- wrap_plots(plots, nrow = 1) + plot_annotation(title = "90 vs. 91")
ggsave("tuning_90_91.png", plot, width = 10, height = 2, dpi = 300)