...
n <- 1000
mu0 <- c(1.5, 0); Sigma0 <- matrix(c(2.5, 0, 0, 1), 2, 2)
mu1 <- c(0, 1.5); Sigma1 <- matrix(c(1,   0, 0, 2.5), 2, 2)
...
logistic_independent <- patchwork::wrap_plots(plots_1, nrow = 1)
ggsave("logistic_independent.png", logistic_independent, width = 12, height = 4, dpi = 300)