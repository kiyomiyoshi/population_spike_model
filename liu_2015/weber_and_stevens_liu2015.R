...
max_firing_seq <- c(20, 30, 42, 51, 60, 70, 71,  73)           # Maximum firing rate of each neuron
...
g1 <- ggplot(df_sum, aes(x = Sum_spikes, color = Contrast, fill = Contrast)) +
  geom_density(alpha = 0.2, linewidth = 1) +
  theme_classic() + facet_wrap(. ~ Contrast) +
  labs(
    x = "Sum of spikes",
    y = "Density",
...
ggsave("weber_stevens_liu_2015.png", g, width = 4, height = 4, dpi = 300)