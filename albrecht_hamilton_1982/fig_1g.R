# Simulation based on Albrecht & Hamilton (1982, fig. 1G)
...
a <- -146 # fixed at 60 for comparability
b <-  143

Max_firing <- a + b * log10(Contrast)
df_ah <- data.frame(Contrast, Max_firing)
df_ah <- df_ah[df_ah$Max_firing >= 0, ]
...
ggsave("fig_1g.png", g, width = 4, height = 5.6, dpi = 300)